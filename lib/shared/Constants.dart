...
class Constants {
  //static const ROOT = Uri.parse('http://10.0.2.2/flutter_api.php');
  ...
  static final String g2pGetCardsListAPI =
      "https://cms.gatetopay.com/G2P.OPENAPI/api/Broker/GetCardList";
  static final String g2pDepositAPI =
      "https://cms.gatetopay.com/G2P.OPENAPI/api/Broker/Deposit";
  static final String g2pInquireTransAPI =
      "https://cms.gatetopay.com/G2P.OPENAPI/api/Inquire/InquireTransaction";
